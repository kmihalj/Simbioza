...
After successful migrations, first-administrator creation, and theme import, it
...
autoloading, migrations, the theme package, and required read/write access. Fix
...
administrator, and only then writes the lock.
