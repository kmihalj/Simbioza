...
return new class implements ReversibleMigrationInterface {
    /**
     * HR: Kreira izvedeni višejezični indeks objavljenih Workspace stranica.
     *     ACL se namjerno računa pri svakom upitu, a ne kopira u indeks.
     * EN: Creates the derived multilingual index of published Workspace pages.
     *     ACL is intentionally evaluated per query rather than copied into the index.
     */
    ...
    /**
     * HR: Uklanja samo ponovno izgradivi indeks pretrage.
     * EN: Removes only the rebuildable search index.
     */
